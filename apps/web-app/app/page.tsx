...
import { useFirebaseGoogleAuth } from "@web/auth/google";
import { useToken } from "@web/auth";
      ...
      <main className="min-h-full min-w-full row-span-2 flex justify-center items-center ">
        <div className="ring-1 dark:ring-slate-900 ring-slate-200 rounded-xl min-h-96 min-w-72 p-8 shadow-xl">
          <section className="-space-y-2">
            <h6 className="text-base">Log in to</h6>
            <h1 className="text-4xl font-black">REVIEW_APP</h1>
            <br />
            <h6 className="text-base w-1/2">
